...
const MyApplications = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        ...
        const response = await axios.get('https://itians-community-backend-production.up.railway.app/api/my-applications', {
          headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://itians-community-backend-production.up.railway.app/api/job-application/${selectedApplication.id}`,
        formDataToSend,
        {
          headers: {
      ...
      setTimeout(async () => {
        ...
        const token = localStorage.getItem('access-token');
        try {
          const updated = await axios.get('https://itians-community-backend-production.up.railway.app/api/itian/job-application', {
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios.delete(`https://itians-community-backend-production.up.railway.app/api/job-application/${applicationToDelete}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });

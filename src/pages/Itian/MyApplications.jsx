...
const MyApplications = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        ...
        const response = await axios.get('http://c6a0-41-33-92-146.ngrok-free.app/api/my-applications', {
          headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `http://c6a0-41-33-92-146.ngrok-free.app/api/job-application/${selectedApplication.id}`,
        formDataToSend,
        {
          headers: {
      ...
      setTimeout(async () => {
        ...
        const token = localStorage.getItem('access-token');
        try {
          const updated = await axios.get('http://c6a0-41-33-92-146.ngrok-free.app/api/itian/job-application', {
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios.delete(`http://c6a0-41-33-92-146.ngrok-free.app/api/job-application/${applicationToDelete}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });

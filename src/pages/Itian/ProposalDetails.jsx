...
const ProposalDetails = () => {
  ...
  const fetchProposal = async () => {
    try {
      ...
      const response = await axios.get(`https://itians-community-backend-production.up.railway.app/api/job-application/single/${id}`, {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`https://itians-community-backend-production.up.railway.app/api/job-application/${id}`, formDataToSend, {
        headers: {
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios.delete(`https://itians-community-backend-production.up.railway.app/api/job-application/${id}`, {
        headers: { 'Authorization': `Bearer ${token}` }
      });

...
export const updatePost = async (postId, data) => {
  ...
  const response = await axios.post(
    `https://itians-community-backend-production.up.railway.app/api/posts/${postId}?_method=PUT`,
    formData,
    {
      headers: {
        'Authorization': `Bearer ${token}`,
...
export const createPost = async (postData) => {
  ...
  const response = await axios.post('https://itians-community-backend-production.up.railway.app/api/posts', formData, {
    headers: {

...
export const updatePost = async (postId, data) => {
  ...
  const response = await axios.post(
    `http://c6a0-41-33-92-146.ngrok-free.app/api/posts/${postId}?_method=PUT`,
    formData,
    {
      headers: {
        'Authorization': `Bearer ${token}`,
...
export const createPost = async (postData) => {
  ...
  const response = await axios.post('http://c6a0-41-33-92-146.ngrok-free.app/api/posts', formData, {
    headers: {
